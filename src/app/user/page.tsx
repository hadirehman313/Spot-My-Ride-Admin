...
export default function User() {
  ...
  async function toggleUserStatus(userId: string, docId: string, currentStatus: boolean) {
    try {
              ...
              <div className="p-6">
                ...
                >
                  ...
                  <motion.button
                    ...
                    onClick={() => {
                      if (selectedUser) {
                        toggleUserStatus(selectedUser.id, selectedUser.docId, selectedUser.active);
                      }
                      closeModals();
                    }}
                  >
